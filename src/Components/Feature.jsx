    ...
    return (
        <div id='features'>
            <div className = 'a-container'>
                ...
                <FeatureHeader image={featureimage1} title='C++ Project' text = "Developed in C++, this console based program takes in an input map of UIC's campus from openstreetmap.org. The program takes in two inputs 
